...
const items = [
  {
    ...
    text: "Guias falando Português, com profundo conhecimento cultural e religioso, para enriquecer cada momento da JMJ.",
  },
  {
    icon: Coffee,
    title: "Refeições Incluídas",
    text: "Café da manhã e jantar todos os dias, para que você se preocupe apenas com a experiência espiritual da Jornada.",
  },
  {
    icon: Plane,
    title: "Voos e Transfers",
    text: "Toda a logística de transporte está incluída — dos voos internacionais aos transfers entre Seul e os locais oficiais da JMJ.",
  },
  {
    icon: Hotel,
    title: "Hotéis Categoria Turística Superior",
    text: "Hospedagem selecionada pelo conforto e localização privilegiada, garantindo descanso entre os eventos da Jornada.",
  },
  {
    icon: ShieldCheck,
