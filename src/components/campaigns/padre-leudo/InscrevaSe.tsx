      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center max-w-5xl mx-auto">
          <div className="text-center md:text-left">
            ...
            <a
              href="https://api.whatsapp.com/send/?phone=5519994718930&text=Ol%C3%A1%21+Quero+garantir+minha+vaga+na+peregrina%C3%A7%C3%A3o+%C3%A0+Turquia+com+o+Padre+Leudo.&type=phone_number&app_absent=0"
              target="_blank"
