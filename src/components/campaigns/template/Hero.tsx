...
const Hero = () => {
  return (
    <section id="inicio" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <img src={heroImage} alt="Safári pela savana africana com paisagem natural da África do Sul" fetchPriority="high" decoding="async" className="absolute inset-0 w-full h-full object-cover" />
