    ...
    <section id="roteiro" className="pt-12 md:pt-28 pb-6 md:pb-10 bg-background">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mt-10">
          <a
            href="https://api.whatsapp.com/send/?phone=5519989542633&text=Ol%C3%A1%21+Gostaria+de+mais+informa%C3%A7%C3%B5es+sobre+o+roteiro+da+viagem+%C3%A0+Turquia.&type=phone_number&app_absent=0"
            target="_blank"
