    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 pt-20 pb-16 text-center">
        ...
        <p className="font-body text-lg md:text-xl text-primary-foreground/90 max-w-2xl mx-auto mb-10 animate-fade-in-up" style={{ animationDelay: "0.3s" }}>
          Caminhe por terras bíblicas e descubra a riqueza espiritual e histórica da Turquia com a Renova Turismo.
        </p>
        ...
        <a
          href="#contato"
          className="inline-block bg-secondary hover:bg-secondary/90 text-secondary-foreground font-heading font-bold text-lg px-10 py-4 rounded-lg transition-all hover:scale-105 shadow-lg animate-fade-in-up"
