      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center max-w-5xl mx-auto">
          ...
          <div className="text-center md:text-left">
            ...
            <a
              href="https://api.whatsapp.com/send/?phone=5519994718930&text=Ol%C3%A1%21+Quero+garantir+minha+vaga+na+viagem+%C3%A0+Turquia+com+a+Renova+Turismo.&type=phone_number&app_absent=0"
              target="_blank"
          ...
          <div className="bg-card rounded-2xl shadow-lg p-8">
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="space-y-2">
                  <Label htmlFor="email" className="font-body text-foreground">E-mail</Label>
                  <Input
                    id="email"
                    type="email"
                ...
                <div className="space-y-2">
                  <Label htmlFor="telefone" className="font-body text-foreground">Telefone / WhatsApp</Label>
                  <Input
                    id="telefone"
                    type="tel"
