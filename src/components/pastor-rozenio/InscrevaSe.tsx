...
const InscrevaSe = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const message = `Olá, Pastor Rozenio! 🙏\n\nMeu nome é ${nome} e vim pela sua página de caravanas evangélicas da Renova Turismo. Gostaria de reservar meu lugar na próxima caravana e receber mais informações (datas, valores e o que está incluso).\n\n📧 E-mail: ${email}\n📱 Telefone: ${telefone}\n\nFico no aguardo do seu retorno!`;
    window.open(
